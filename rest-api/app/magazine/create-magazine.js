jQuery(function($){
    ...
    $(document).on("click", ".create-product-button", function() {
        ...
        $.getJSON("http://rest-api/api/author/read.php", function(data) {
            ...
            var authors_options_html=`<select name="id_author" id="id_author" class="form-control">`;
    ...
    $(document).on("submit", "#create-product-form", function(){
        ...
        var form_data = {'title':title, 'description': description, 'id_author':id_author, 'images': images};
        //form_data[0].push({"images": f});
