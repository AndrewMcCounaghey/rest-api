...
--!>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr>
                ...
                <th class="w-10-pct">Изображение</th>
    ...
    $.each(data.records, function(key, val) {
        ...
        read_products_html+=`<tr>
            ...
            <td>` + val.title + `</td>
            <td><img class="image" src="/api/objects/uploads/` + val.images + `.jpg"/></td>
            <td>` + val.surname_author + ` ` + val.name_author + ` ` + val.lastname_author + `</td>
